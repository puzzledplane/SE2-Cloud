<?php
	...
	*												forgotpassword.php													   *
	************************************************************************************************************************
	*	This file contains code to retrieve a users account by resetting their forgotten password.  Actions include  	   *
													...
													<ul>
														<li class="box">';
															...
															if ($total == 1)
															{
																...
																<br />
																<br />
																Please <a href="'.$dbsite_url.'/forgotpassword.php?action=verify&email='.$email.'&key='.$key.'">click here</a> to reset your
																password.
																<br />
																<br />
														...
														<li class="box">';
															...
															if (isset($_POST['password']) && isset($_POST['key']))
															{
																...
																if ($pwd == $confirm)
																{
																	...
																	$update = "UPDATE users SET Salt = '$salt', Password = '$hash' WHERE Email = '$email'";
