<?php
	...
	*												   weeklystepcount.php												   *
	************************************************************************************************************************
	*	This include file contains code to get step count data on a weekly basis. This file cannot be					   *
	...
	************************************************************************************************************************/
	...
	else
	{
		...
		$query = "SELECT * FROM sensors WHERE Type = 'Steps' AND users_UserID = '".$_SESSION['SE_User_ID']."' AND YEARWEEK(Date) = YEARWEEK(NOW()) ORDER BY Date ASC";
		...
		if($result = mysqli_query($con, $query))
		{
			...
			else
			{
				...
				{
					$weeklysteps += $rows['Data'];
					$lastweeklyupdate = $rows['Date'];
				}
			}
